        ...
        if (presence.getType().equals( Presence.Type.subscribe )) {
            ...
            for (Friend friend : XmppConnection.getInstance().getFriendList()) {
                if (friend.getUsername().equals( XmppConnection.getUsername( jid ) ) && friend.getType() == ItemType.to) {
                    ...
                    MyAndroidUtil.showNoti( ChatItem.FRIEND, "friend", nickName + "Đồng ý để thêm bạn", null, nickName, head );
                    ...
                    MyAndroidUtil.showNoti( ChatItem.FRIEND, "friend", nickName + "Áp dụng để thêm bạn", null, nickName, head );
