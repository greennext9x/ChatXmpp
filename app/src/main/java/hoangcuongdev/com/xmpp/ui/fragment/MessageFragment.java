...
import hoangcuongdev.com.xmpp.presenter.MessagePresenter;
import hoangcuongdev.com.xmpp.ui.activity.ChatActivity;
import hoangcuongdev.com.xmpp.ui.adapter.MessageAdapter;
...
public class MessageFragment extends BaseFragment<MessagePresenter> implements MessageView{
    ...
    private void initDialog() {
        dialog = new NormalListDialog( mContext,new String[]{"Xóa trò chuyện"} );
