...
import hoangcuongdev.com.xmpp.ui.activity.ShowBigImgActivity;
...
import hoangcuongdev.com.xmpp.wight.bubble.BubbleImageView;
    ...
    private void showBivPic(BaseViewHolder helper, ChatItem item) {
        ...
        Observable.create( (Observable.OnSubscribe<Bitmap>) subscriber -> {
            ...
            if (headimg != null) {
                ...
                subscriber.onError( new Throwable( "Không có avatar" ) );
            }
        } ).subscribeOn( Schedulers.io() )
                .observeOn( AndroidSchedulers.mainThread() )
