...
import hoangcuongdev.com.xmpp.model.bean.UserInfoData;
import hoangcuongdev.com.xmpp.presenter.UserInfoPresenter;
...
import hoangcuongdev.com.xmpp.wight.dialog.CheckDialog;
    ...
    private void initListener() {
        ...
        RxView.clicks( mOivName )
                ...
                .subscribe( aVoid -> {
                    ...
                    infoData.setTitle( "Chỉnh sửa tài khoản" );
        ...
        RxView.clicks( mOivSignature )
                ...
                .subscribe( aVoid -> {
                    ...
                    infoData.setTitle( "Chỉnh sửa chữ ký" );
                    Intent intent = new Intent( UserInfoActivity.this,ReviseActivity.class );
                    intent.putExtra( "userinfo", infoData );
                    startActivity( intent );
                } );
