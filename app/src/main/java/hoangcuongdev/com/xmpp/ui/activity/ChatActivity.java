...
import hoangcuongdev.com.xmpp.model.bean.LocationData;
...
import hoangcuongdev.com.xmpp.presenter.ChatPresenter;
import hoangcuongdev.com.xmpp.scoket.XmppConnection;
import hoangcuongdev.com.xmpp.ui.adapter.ChatAdapter;
...
import static hoangcuongdev.com.xmpp.utils.ImageUtil.getBase64StringFromFile;
                ...
                rxPermissions.request( Manifest.permission.RECORD_AUDIO
                        ...
                        .subscribe( granted -> {
                            if (granted) {
                                ...
                                showTip( "Vui lòng cho phép quyền ghi âm" );
                            }
                        } );
            }
        } );
        ...
        RxView.clicks( mIvAlbum )
                ...
                .subscribe( granted -> {
                    if (granted) {
                        ...
                        showTip( "Vui lòng cho phép quyền đọc và ghi" );
                    }
                } );
        RxView.clicks( mIvShot )
                ...
                .subscribe( granted -> {
                    if (granted) {
                        ...
                        showTip( "Vui lòng cho phép quyền camera" );
                    }
                } );
        RxView.clicks( mIvLocation )
                ...
                .subscribe( granted -> {
                    if (granted) {
                        ...
                        showTip( "Vui lòng cho phép quyền xem vị trí" );
                    }
                } );
