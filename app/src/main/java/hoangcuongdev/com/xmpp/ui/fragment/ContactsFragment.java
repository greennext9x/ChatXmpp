...
import hoangcuongdev.com.xmpp.presenter.ContactsPresenter;
import hoangcuongdev.com.xmpp.ui.activity.ChatActivity;
import hoangcuongdev.com.xmpp.ui.activity.FriendInfoActivity;
import hoangcuongdev.com.xmpp.ui.activity.GroupChatActivity;
import hoangcuongdev.com.xmpp.ui.activity.NewFriendActivity;
import hoangcuongdev.com.xmpp.ui.adapter.ContactsAdapter;
import hoangcuongdev.com.xmpp.ui.view.ContactsView;
import hoangcuongdev.com.xmpp.utils.PinyinUtils;
import hoangcuongdev.com.xmpp.utils.UIUtils;
import rx.Observable;
import rx.android.schedulers.AndroidSchedulers;
import rx.schedulers.Schedulers;

import static hoangcuongdev.com.xmpp.R.id.rvContacts;
    ...
    public void onNext(List<Friend> friendList) {
        ...
        Observable.from( friendList )
                ...
                .subscribe( list -> {
                    ...
                    initSideBar();
                    mFooterTv.setText(friendList.size()+"Người liên hệ");
